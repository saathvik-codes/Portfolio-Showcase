...
export default function Experience() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".exp-card", {
        y: 50, opacity: 0, duration: 0.9, ease: "power3.out", stagger: 0.18,
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end gap-6 mb-16">
          ...
          >
            <span className="clip-line-wrap"><span className="exp-clip-line">Where I've</span></span>
            <span className="clip-line-wrap"><span className="exp-clip-line gradient-text">grown.</span></span>
          </h2>
              ...
              <div key={i} className="exp-card relative group" data-testid={`exp-card-${i}`}>
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-5">
                    ...
                    <div className="font-mono text-xs text-white/25 shrink-0 text-right leading-relaxed">{exp.period}</div>
                  </div>
